        ...
        <div className="glass-panel rounded-2xl p-6 overflow-y-auto">
          ...
          {result && (
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
              {/* Score */}
              <div className="text-center p-6 bg-surface-container-low rounded-xl border border-white/5">
              ...
              <div>
                ...
                <ul className="space-y-3">
                  {result.suggestions?.map((sug, i) => (
                    <li key={i} className="bg-surface-container-high p-4 rounded-lg text-sm text-on-surface flex items-start gap-3 border border-white/5">
