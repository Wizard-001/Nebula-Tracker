...
const COLUMN_COLORS = {
  ...
  Applied: { dot: 'bg-secondary', header: 'text-secondary' },
  Interviewing: { dot: 'bg-primary', header: 'text-primary' },
...
const CardActionsMenu = ({ application, onClose }) => {
  ...
  return (
    ...
    >
      <div className="px-3 py-2 text-[11px] font-semibold uppercase tracking-wider text-on-surface-variant border-b border-outline">
        Move to
      </div>
    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="glass-panel w-full max-w-lg p-6 rounded-2xl relative">
        <div className="flex items-center justify-between mb-5">
          <h2 className="text-xl font-bold text-gradient">Edit Application</h2>
      ...
      <Draggable draggableId={application._id} index={index}>
        {(provided, snapshot) => (
          ...
          >
            ...
            <div className="flex gap-1 mt-3 pt-2 border-t border-outline opacity-0 group-hover:opacity-100 transition-opacity">
              <button
