...
export const ProfileDropdown = () => {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-14 w-56 glass-panel rounded-xl overflow-hidden shadow-2xl z-50 border border-outline animate-in fade-in slide-in-from-top-2 duration-200">
    ...
    <SidebarContext.Provider value={{ sidebarOpen, setSidebarOpen }}>
      <div className="flex min-h-screen bg-background text-on-background">
        ...
        >
          ...
          <header className="sticky top-0 z-20 flex items-center justify-between px-6 py-3 border-b border-outline bg-background/80 backdrop-blur-xl">
            <button
