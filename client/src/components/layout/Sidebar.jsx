...
const Sidebar = ({ collapsed }) => {
  ...
  return (
    <div
      className={`h-full glass-panel flex flex-col py-6 fixed top-0 left-0 z-30 border-r border-outline transition-all duration-300 ${
        collapsed ? 'w-16' : 'w-64'
      }`}
    >
      {/* Logo */}
      ...
      {/* Bottom branding */}
      <div className={`pt-4 border-t border-outline ${collapsed ? 'px-2' : 'px-6'}`}>
