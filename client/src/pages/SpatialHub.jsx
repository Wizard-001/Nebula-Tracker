...
const modules = [
  {
    ...
    icon: <LayoutDashboard size={32} className="mb-4 text-primary" />,
  ...
  },
  {
    ...
    icon: <ListTodo size={32} className="mb-4 text-secondary" />,
  ...
  },
  {
    ...
    icon: <FileSearch size={32} className="mb-4 text-primary" />,
    color: 'from-primary/20 to-tertiary/20',
    border: 'border-primary/30',
  ...
  },
  {
    ...
    icon: <Mic size={32} className="mb-4 text-secondary" />,
  ...
  const renderActiveComponent = () => {
    ...
    return (
      <motion.div
        ...
        className="absolute inset-x-8 inset-y-24 md:inset-x-20 md:inset-y-20 z-40 rounded-3xl overflow-hidden backdrop-blur-2xl bg-black/40 border border-outline shadow-[0_0_100px_rgba(0,0,0,0.5)] flex flex-col"
      >
        <div className={`h-2 w-full bg-gradient-to-r ${mod.color}`} />
        
        <div className="flex justify-between items-center px-8 py-4 border-b border-outline bg-white/5">
        ...
        <div className="flex-1 overflow-auto p-6 relative">
          <Suspense fallback={<div className="absolute inset-0 flex items-center justify-center text-on-surface-variant">Loading interface...</div>}>
            {mod.component}
          </Suspense>
        </div>
      </motion.div>
