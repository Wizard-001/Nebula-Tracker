      ...
      <div className="glass-panel p-6 rounded-2xl">
        ...
        {hasResume ? (
          <>
            ...
            {/* Preview */}
            <div className="bg-surface-container-low rounded-xl p-4 border border-outline mb-4 max-h-72 overflow-y-auto">
          ...
          <div className="text-center py-10 bg-surface-container-low rounded-xl border border-outline">
...
const Profile = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      {/* Tab Navigation */}
      <div className="flex gap-1 bg-surface-container-low/50 p-1 rounded-xl mb-6 border border-outline">
        {TABS.map(tab => (
          <button
            key={tab.id}
